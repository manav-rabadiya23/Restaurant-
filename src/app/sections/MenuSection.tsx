    ...
    <section id="menu" className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
      ...
      <div className="mx-auto mb-6 max-w-xl">
        <div className="relative">
          ...
          <input
            ...
            className="h-14 w-full rounded-2xl border border-white/10 bg-white/5 pl-12 pr-4 text-white outline-none focus:border-orange-400"
          />
        </div>
      </div>
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filteredMenu.map((item) => (
          <div
            key={item.name}
            className="group overflow-hidden rounded-[28px] border border-white/10 bg-white/5 shadow-xl transition duration-300 hover:-translate-y-2 hover:border-orange-400/30"
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-orange-500 to-yellow-400 px-4 py-3 font-semibold text-black transition hover:scale-[1.02]"
                >
